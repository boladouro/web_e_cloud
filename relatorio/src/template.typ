...
#let as_cited_in(citation, as_cited, lang: "pt") = {
  [(#cite(citation, form:"author"), #cite(citation, form:"year"),
    #if lang == "pt" {[como citado em]} else {[as cited in]}
    #cite(as_cited, form:"author"), #cite(as_cited, form:"year"))
  ]
}
